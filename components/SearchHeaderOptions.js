...
export default function SearchHeaderOptions() {
  ...
  return (
    <div className="flex gap-8 items-center justify-center select-none w-full text-sm text-gray-700 sm:justify-start sm:pl-[10.6rem] md:pl-44 border-b mt-1 transition duration-500 ease-in-out">
